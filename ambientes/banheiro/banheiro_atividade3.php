...
<body>
    ...
    <div class="container">
        ...
        <div id="teclado">
            ...
            <div class="teclas">
                ...
                <button id="tecla--" onclick="verificaLetraEscolhida('-')">-</button>
                <BR><br>
                <center><button id="btnReiniciar">🎮</button></center>
            </div>
        </div>
    ...
    <script src="../../js/Banheiro/forca_banheiro.js"></script>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"
        ...
        <br><br><br>
        <b><center><a href="banheiro.php">Voltar</a></center></b>
</body>
