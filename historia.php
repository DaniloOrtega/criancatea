...
<body class="is-preload homepage">
  <div id="page-wrapper">
    ...
    <!-- Conteudo -->
    <div class="historia">
      <h2> <u>Acontecimentos na história do autismo</u> </h2>
      <font color="blue">
        <br>
        <h3><u>No ano de 2022</u></h3>
        <p>
